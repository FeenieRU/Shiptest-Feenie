...
/datum/bark/mutedc2
	...
	id = "mutedc2"
	soundpath = 'sound/barks/guitar/C2.ogg'

/datum/bark/mutedc3
	name = "Muted String (Medium)"
	id = "mutedc3"
	soundpath = 'sound/barks/guitar/C3.ogg'

/datum/bark/mutedc4
	name = "Muted String (High)"
	id = "mutedc4"
	soundpath = 'sound/barks/guitar/C4.ogg'

/datum/bark/banjoc3
	name = "Banjo (Medium)"
	id = "banjoc3"
	soundpath = 'sound/barks/banjo/Cn3.ogg'

/datum/bark/banjoc4
	name = "Banjo (High)"
	id = "banjoc4"
	soundpath = 'sound/barks/banjo/Cn4.ogg'

/datum/bark/bikehorn
	name = "Bikehorn"
	id = "horn"
	soundpath = 'sound/barks/bikehorn/Cn4.ogg'
...
/datum/bark/synthetic_grunt
	...
	id = "synthgrunt"
	soundpath = 'sound/barks/misc/bloop.ogg'

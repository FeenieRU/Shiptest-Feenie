...
ID мода: CELADON_AMMO_WORKBENCH
<!--
...
Модификация добавляет в билд патронный верстак для упрощённой перезарядки магазинов.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/weapon_workbench.dm`: `WEAPON_WORKBENCH_SPEED_MULTIPLIER`, `WEAPON_WORKBENCH_SPEED_BASE`
-->

### Используемые файлы, не содержащиеся в модпаке

- `mod/icons/obj/machines/ammo_workbench.dmi`
<!--
...
Feenie
(порт с https://github.com/NovaSector/NovaSector)
<!--
